...
INSERT INTO "user" (username, name, email, password, activated)
SELECT * FROM (SELECT 'admin@admin.com', 'Admin', 'admin@admin.com', '$2a$10$r0RFDmpneBVryx.ihHK9gu6FFJQi4nTxQUqzdSTvrPpaKZMxigqpy', true) AS tmp
WHERE NOT EXISTS (
